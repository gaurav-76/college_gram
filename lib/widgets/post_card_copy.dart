...
class PostCard1 extends StatefulWidget {
  final snap;
  const PostCard1({Key? key, required this.snap}) : super(key: key);
                    ...
                    IconButton(
                        onPressed: () {
                          widget.snap['uid'] == user.uid
                              ...
                              : showSnackBar(
                                  "You cannot delete this post.", context);
                        },
              ...
              children: [
                 IconButton(
                  ...
                  icon: widget.snap['likes'].contains(user.uid)
                       ? const Icon(Icons.thumb_up_alt_rounded, color: Colors.black)
                       : const Icon( Icons.thumb_up_alt_outlined,size: 24.0,color: Color.fromARGB(255, 113, 112, 112),),
                ),
                Padding(
                  ...
                  child: TextButton.icon(
                    ...
                    label: const Text(
                      'Comment',
                      style:
                          TextStyle(color: Color.fromARGB(255, 113, 112, 112)),
                    ),
                  ),
                ),
                Spacer(),
